                ...
                <div className="magic-bento-card__content">
                  ...
                  {card.credential && (
                    <a
                      ...
                      style={{ position: 'relative', zIndex: 10, display: 'inline-flex', alignItems: 'center', gap: '0.25rem', marginTop: '0.5rem', color: '#915EFF', fontSize: '0.85rem', textDecoration: 'none' }}
                    >
                      View Credential
